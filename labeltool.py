...
parser.add_argument('-i', nargs=1, help='input image path', dest='input', required=True)
...
shutil.move(f"{img_name}.npz", "C:\\Users\\Davison\\Desktop\\OpenDataset\\npz")
shutil.move(f"{img_name}-roi.png", "C:\\Users\\Davison\\Desktop\\OpenDataset\\npz")
